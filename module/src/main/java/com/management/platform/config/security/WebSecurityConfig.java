package com.management.platform.config.security;

import com.management.platform.core.auth.entrypoint.JwtAuthenticationEntryPoint;
import com.management.platform.core.auth.filter.JwtAuthorizationTokenFilter;
import com.management.platform.core.auth.userdetail.JwtUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeRequests()
                .anyRequest().permitAll().and().logout().permitAll();//配置用户任意请求不需要登录验证
