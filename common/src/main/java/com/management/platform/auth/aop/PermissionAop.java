...
//        MethodSignature checkSession = (MethodSignature) point.getSignature();
//        Method checkSessionMethod = checkSession.getMethod();
//        CheckSession checkSessionClass = checkSessionMethod.getAnnotation(CheckSession.class);
//        Boolean checkSessionValue = checkSessionClass.value();
